...
<div id="nav-overlay" class="fixed inset-0 bg-black/40 hidden z-40"></div>
<aside id="mobile-nav" class="fixed inset-y-0 left-0 z-50 w-72 max-w-[85vw] -translate-x-full transform bg-white shadow-xl transition-transform duration-300 ease-in-out will-change-transform overflow-y-auto">
